...
Usage:
    python gen_ukraine_data.py --count 100 --seed 42 --db caribbean.duckdb
"""
...
def main():
    parser = argparse.ArgumentParser(description='Generate Ukraine telecommunications data')
    parser.add_argument('--countries', nargs='+', default=['Ukraine'],
                       choices=['Ukraine'],
    ...
    generator = UkraineDataGenerator(
