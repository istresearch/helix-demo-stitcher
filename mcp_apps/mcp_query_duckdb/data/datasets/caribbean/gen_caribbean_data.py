#!/usr/bin/env python3
"""
Caribbean Data Generator

Generates synthetic CDR, MAID, and connection data for the Caribbean region.
Covers maritime communications in the Caribbean Sea and surrounding areas.

Usage:
    python gen_caribbean_data.py --count 100 --seed 42 --db caribbean.duckdb
"""
...
class CountryConfig:
    """Configuration for Caribbean countries and territories."""
...
class CaribbeanDataGenerator:
    """Generate Caribbean telecommunications data."""
...
def main():
    parser = argparse.ArgumentParser(description='Generate Caribbean telecommunications data')
    parser.add_argument('--countries', nargs='+', default=['Cuba', 'Jamaica', 'Haiti', 'Dominican_Republic'],
                       choices=['Cuba', 'Jamaica', 'Haiti', 'Dominican_Republic', 'Puerto_Rico'],
    ...
    generator = CaribbeanDataGenerator(
